...
def analyze(match:dict):
    ...
    for i in range(game):
        glicko_1.append(ML_in_game2.predictGlicko(apm_1[i], pps_1[i], vs_1[i], apm_2[i], pps_2[i], vs_2[i], t[i]))
        glicko_2.append(ML_in_game2.predictGlicko(apm_2[i], pps_2[i], vs_2[i], apm_1[i], pps_1[i], vs_1[i], t[i]))
